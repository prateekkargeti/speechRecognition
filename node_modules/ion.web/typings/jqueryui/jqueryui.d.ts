...
// Actually this is to align the bootstrap API of tooltip
declare namespace BootstrapUI {
    interface Tooltip {
        options: TooltipOptions;
        tip(index: number): JQuery;
    }
...
declare namespace JQueryUI {
    ...
    interface UIMouse {
        ...
        _mouseInit: () => void;
        _mouseDestroy: () => void;
        _touchStart: (event: TouchEvent & { originalEvent: TouchEvent }) => void;
        _touchMove: (event: TouchEvent & { originalEvent: TouchEvent }) => void;
        _touchEnd: (event: TouchEvent & { originalEvent: TouchEvent }) => void;
    }
...
interface JQuery {
    ...
    tooltip(options: BootstrapUI.TooltipOptions): JQuery;
