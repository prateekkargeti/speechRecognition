...
declare namespace ng {
    ...
    interface IRootScopeService {
        ...
        $new<T extends ng.IScope>(isolate?: boolean, parent?: IScope): T;
    ...
    /**
     * A generic angular scope
     */
    interface ISafeScope extends IRootScopeService {}

    /**
     * The angular scope
     * @deprecated Please use the ISafeScope instead, to allow compilation errors to be spotted in case of undeclared properties.
     */
    ...
    interface IQService {
         ...
         * Race
         */
        race(promises: IPromise<any>[]): IPromise<any>;
        /**
         * Combines multiple promises into a single promise that is resolved when all of the input promises are resolved.
         *
         * Returns a single promise that will be resolved with an array/hash of values, each value corresponding to the promise at the same index/key in the promises array/hash. If any of the promises is resolved with a rejection, this resulting promise will be rejected with the same rejection value.
         ...
         * @param value Value or a promise
         */
        when<T>(value: T | Q.IPromise<T>): IPromise<T>;
        /**
         * Wraps an object that might be a value or a (3rd party) then-able promise into a $q promise. This is useful when you are dealing with an object that might or might not be a promise, or if the promise comes from a source that can't be trusted.
         *
         * @param value Value or a promise
    ...
    interface IPromise<T> {
         ...
         */
        then<TResult>(
            successCallback: (promiseValue: T) => IHttpPromise<TResult>,
         ...
         */
        then<TResult>(
            successCallback: (promiseValue: T) => IPromise<TResult>,
            errorCallback?: (reason: any) => any,
            notifyCallback?: (state: any) => any
        ): IPromise<TResult>;
        /**
    ...
    interface ICompileProvider extends IServiceProvider {
        ...
        preAssignBindingsEnabled(enabled?: boolean): void;
    }
    ...
    interface IAugmentedJQuery extends JQuery {
        ...
        /**
         * Access the scope from an Element.
         * @deprecated Please don't use since requires Debug Mode of AngularJS
         */
        scope(): IScope;

        /**
         * Access the isolated scope from an Element.
         * @deprecated Please don't use since requires Debug Mode of AngularJS
         */
        isolateScope(): IScope;
    ...
    interface IAnimateService {
        ...
        enabled(element: JQuery, enabled: boolean): void;
    }
